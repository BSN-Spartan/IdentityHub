package com.reddate.hub.sdk.service;

import com.alibaba.fastjson.JSONObject;
import com.reddate.hub.sdk.constant.ErrorMessage;
import com.reddate.hub.sdk.constant.ServiceURL;
...
import com.reddate.hub.sdk.protocol.response.ResultData;
import com.reddate.hub.sdk.protocol.response.hub.*;
import com.reddate.hub.sdk.util.*;
...
public class HubService extends BaseService {
	...
	public RegisterHubResult registerHubByIdPublicKey(String id, String publicKey,CryptoType cryptoType) {
		if (StringUtils.isBlank(publicKey)) {
			throw new HubException(ErrorMessage.PARAMETER_IS_EMPTY.getCode(), "publicKey is null");
		}
		
		if(cryptoType == null) {
			throw new HubException(ErrorMessage.PARAMETER_IS_EMPTY.getCode(), "cryptoType is null");
		}
	...
	public SaveResourceResult saveResource(SaveResource saveResource) {
		if (saveResource == null) {
			throw new HubException(ErrorMessage.PARAMETER_IS_EMPTY.getCode(), "saveResource is null");
		}
		if (StringUtils.isBlank(saveResource.getUid())) {
			throw new HubException(ErrorMessage.PARAMETER_IS_EMPTY.getCode(), "uid is null");
		}
		if (StringUtils.isBlank(saveResource.getContent())) {
			throw new HubException(ErrorMessage.PARAMETER_IS_EMPTY.getCode(), "content is null");
		}
		if (StringUtils.isBlank(saveResource.getOwnerUid())) {
			throw new HubException(ErrorMessage.PARAMETER_IS_EMPTY.getCode(), "ownerUid is null");
		}
		if (saveResource.getGrant() == null) {
			throw new HubException(ErrorMessage.PARAMETER_IS_EMPTY.getCode(), "grant is null");
		}
		if (saveResource.getGrant() != Operation.WRITE) {
			if (StringUtils.isBlank(saveResource.getUrl())) {
				throw new HubException(ErrorMessage.PARAMETER_IS_EMPTY.getCode(), "url is null");
			}
		}
		if (StringUtils.isBlank(saveResource.getPrivateKey())) {
			throw new HubException(ErrorMessage.PARAMETER_IS_EMPTY.getCode(), "privateKey is null");
		}
		...
		if ((saveResource.getGrant() == Operation.WRITE || saveResource.getGrant() == Operation.UPDATE)
			...
			if (!checkPermissionResp.isSucces()) {
				...
				throw new HubException(ErrorMessage.QUERY_GRANT_ENCPY_KEY_FAILED.getCode(),
	...
	public CreatePermissionResp createPermission(CreatePermission createPermission) {
		...
		if (StringUtils.isBlank(createPermission.getGrantUid())) {
			throw new HubException(ErrorMessage.PARAMETER_IS_EMPTY.getCode(), "grantUid is null");
		}

		if (StringUtils.isBlank(createPermission.getGrantPublicKey())) {
			throw new HubException(ErrorMessage.PARAMETER_IS_EMPTY.getCode(), "grantPublicKey is null");
		}
		...
		if (Operation.UPDATE == createPermission.getGrant()
			...
			if (queryResourceResp == null) {
				throw new HubException(ErrorMessage.RESOURCE_NOT_EISTS.getCode(),
	...
	public DeletePermissionResp deletePermission(DeletePermission deletePermission) {
		if (deletePermission == null) {
			throw new HubException(ErrorMessage.PARAMETER_IS_EMPTY.getCode(), "deletePermission is null");
		}
	...
	public List<PermissionInfo> queryPermission(QueryPermission queryPermission) {
		if (queryPermission == null) {
			throw new HubException(ErrorMessage.PARAMETER_IS_EMPTY.getCode(), "queryPermission is null");
		}
	...
	public CheckPermissionResp checkPermission(CheckPermission checkPermission) {
		if (checkPermission == null) {
			throw new HubException(ErrorMessage.PARAMETER_IS_EMPTY.getCode(), "checkPermission is null");
		}
	...
	public List<ResourceHistoryInfo> queryResourceHistory(QueryResourceHistory queryResourceHistory) {
		if (queryResourceHistory == null) {
			throw new HubException(ErrorMessage.PARAMETER_IS_EMPTY.getCode(), "queryResourceHistory is null");
		}
	...
	public String decrypt(String content, String encptyKey, String privateKey) {
		...
		if(encptyKey == null || encptyKey.trim().isEmpty()) {
			throw new HubException(ErrorMessage.PARAMETER_IS_EMPTY.getCode(), "encptyKey is null");
		}
	...
	public Boolean transferOwner(TransferOwner transferOwner) {
		if (transferOwner == null) {
			throw new HubException(ErrorMessage.PARAMETER_IS_EMPTY.getCode(), "transferOwner is null");
		}
		...
		if (StringUtils.isBlank(transferOwner.getNewOwnerUid())) {
			throw new HubException(ErrorMessage.PARAMETER_IS_EMPTY.getCode(), "newOwnerUid is null");
		}
		if (StringUtils.isBlank(transferOwner.getNewOwnerPublicKey())) {
			throw new HubException(ErrorMessage.PARAMETER_IS_EMPTY.getCode(), "newOwnerPublicKey is null");
		}
	...
	public CryptoType getCryptoTypeByIdOrPublicKey(String uid,String publicKey) {
		if ((uid == null || uid.trim().isEmpty()) && (publicKey == null || publicKey.trim().isEmpty())) {
			throw new HubException(ErrorMessage.PARAMETER_IS_EMPTY.getCode(), "uid and publicKey are null");
		}
		...
		if(type == null) {
			throw new HubException(ErrorMessage.USER_NOT_EXISTS.getCode(), ErrorMessage.USER_NOT_EXISTS.getMessage());
		}
	...
	public static KeyPair generalKeyPairByMnemonic(List<String> mnemList) {
		...
		if(mnemList == null || mnemList.isEmpty()) {
			throw new HubException(ErrorMessage.MNEM_IS_EMPTY.getCode(), ErrorMessage.MNEM_IS_EMPTY.getMessage());
		}
