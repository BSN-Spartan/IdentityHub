...
package com.reddate.hub.sdk.service.ipfs;
...
public class IpfsResourceService {
	...
	public SaveResource uploadResource(String uploadKey, String content, boolean encrypt, CryptoType cryptoType,
		...
		if (uploadKey == null || uploadKey.trim().isEmpty()) {
			throw new HubException(ErrorMessage.PARAMETER_IS_EMPTY.getCode(), "uploadKey is null");
		}
		...
		if (encrypt) {
			...
			try {
				...
				e.printStackTrace();
				throw new HubException(ErrorMessage.ENCRYPT_FAILED.getCode(), ErrorMessage.ENCRYPT_FAILED.getMessage());
			}
	...
	public ResourceInfo downloadResource(String downloadKey, String hash) {
		if (downloadKey == null || downloadKey.trim().isEmpty()) {
			throw new HubException(ErrorMessage.PARAMETER_IS_EMPTY.getCode(), "downloadKey is null");
		}

		if (hash == null || hash.trim().isEmpty()) {
			throw new HubException(ErrorMessage.PARAMETER_IS_EMPTY.getCode(), "hash is null");
		}
