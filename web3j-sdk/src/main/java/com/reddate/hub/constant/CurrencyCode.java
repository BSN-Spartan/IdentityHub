...
public class CurrencyCode {
  ...
  /** Did prefix */
  public static final String DID_PREFIX = "hub";
  ...
  /** */
  public static final String DID_FORMAT_PREFIX =
      DID_PREFIX + DID_SEPARATOR + DID_PROJECT_NAME + DID_SEPARATOR;
  ...
  /** Regular verification of hub identifier */
